...
import { User, Globe, Shield, HelpCircle, LogOut, ChevronRight, X, Moon, Sun } from 'lucide-react';
...
export function SettingsScreen({ onBack }: SettingsScreenProps) {
  ...
  return (
    <div className={`w-full h-full ${isDarkMode ? 'bg-[#0D0D0D]' : 'bg-white'} overflow-y-auto pb-20`}>
      {/* Header */}
